...
set_target_properties(LLVMHello PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/lib/LLVMHello.so"
...
set_target_properties(LLVMTestingSupport PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/lib/libLLVMTestingSupport.a"
  )
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/bin/not"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/bin/yaml-bench"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/lib/BugpointPasses.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/bin/lli-child-target"
  )
...
set_target_properties(Bye PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/lib/Bye.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(TestPlugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/unittests/Passes/TestPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(gtest PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/lib/libgtest.a"
  )
...
set_target_properties(gtest_main PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/home/namrata/libc++-build-10/lib/libgtest_main.a"
  )
